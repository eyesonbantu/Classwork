...
if __name__ == "__main__":
    ...
    checkout(disc_cart)  # Call the checkout function for the discounted cart  # <--- ADDED THIS LINE
    checkout(disc_cart)  # Call the checkout function for the discounted cart
    ...
    checkout(taxed_cart)  # Call the checkout function for the taxed cart  # <--- ADDED THIS LINE
    checkout(taxed_cart)  # Call the checkout function for the taxed cart